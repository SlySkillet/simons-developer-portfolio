  ...
  return (
    <div className="about-container">
      ...
      <p className="about-content bio">
        ...
        interest in software began as a desire to create and solve complex
        puzzles in the process. I find that code combines mathematical logic
        with imaginitive design. I'm excited to keep creating and exploring new
        possibilities in the tech industry.
      </p>
      <p className="about-content bio two">
        Away from the computer, you’ll find me running, diving in deep water,
        snowboarding or whipping up a good meal.
      </p>
      <p className="sub-text">
        Hack Reactor Graduate - 2023 | BA Earlham College - 2014
      </p>
    </div>
  );
}
